...
func (rd *RESTData) getIBCChannels() {
	...
	res, err := HttpQuery(RESTAddr + "/ibc/core/channel/v1beta1/channels" + "?pagination.limit=1000")
	if err != nil {
...
func (rd *RESTData) getIBCConnections() {
	...
	res, err := HttpQuery(RESTAddr + "/ibc/core/connection/v1beta1/connections" + "?pagination.limit=1000")
	if err != nil {
		zap.L().Fatal("", zap.Bool("Success", false), zap.String("err", err.Error()))
	}
	json.Unmarshal(res, &ibcInfo)
